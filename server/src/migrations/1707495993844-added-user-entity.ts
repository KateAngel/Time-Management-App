...
export class AddedUserEntity1707495993844 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "project_title" ADD CONSTRAINT "FK_1fc0476407562dc81a231ed21a0" FOREIGN KEY ("categoryId") REFERENCES "project_category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_586dfdcae7fab5d9723506049a7" FOREIGN KEY ("categoryId") REFERENCES "project_category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_3797a20ef5553ae87af126bc2fe" FOREIGN KEY ("projectId") REFERENCES "project_title"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "project_category" ADD CONSTRAINT "FK_78bee1bfeebb6e746a57981b0c1" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "project_category" DROP CONSTRAINT "FK_78bee1bfeebb6e746a57981b0c1"`);
        ...
        await queryRunner.query(`ALTER TABLE "project_title" DROP CONSTRAINT "FK_1fc0476407562dc81a231ed21a0"`);
        await queryRunner.query(`ALTER TABLE "project_title" DROP CONSTRAINT "FK_aa081bcf5454a6dfa5533fcea47"`);
        await queryRunner.query(`DROP TABLE "project_category"`);
        await queryRunner.query(`DROP TABLE "task"`);
        await queryRunner.query(`DROP TABLE "project_title"`);
        await queryRunner.query(`DROP TYPE "public"."project_title_status_enum"`);
    }
